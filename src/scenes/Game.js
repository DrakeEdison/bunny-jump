...
export default class Game extends Phaser.Scene
{
    ...
    constructor()
    {
        // define unique key for the Game scene
        super('game')
    }

    // load images, audio, or other assets before starting the Scene
    preload()
    {
        ...
        this.load.image('bunny-stand', 'assets/images/Players/bunny1_stand.png')
